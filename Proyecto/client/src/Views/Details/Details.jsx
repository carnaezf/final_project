...
export default function Details({ match: { params: { id } } }){
    ...
    console.log('shoppingBag desde Details', shoppingBag);
    console.log('ShoppingBagContext desde Details', ShoppingBagContext);
...
<br />
        ...
        20% discount on purchases of $100 or more | 25% discount on purchases of $150 or more</h1>
